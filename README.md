...
Built an end-to-end SQL analytics system to analyze 18000+ sales records and generate actionable insights for customer, product, and revenue performance reporting.
